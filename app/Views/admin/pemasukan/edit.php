    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form action="<?= site_url('pemasukan/update/' . ($pemasukan['id'] ?? '')) ?>" method="POST">
                        <?= csrf_field() ?>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="keterangan" class="form-control" rows="3" required><?= old('keterangan', $pemasukan['keterangan'] ?? '') ?></textarea>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="jumlah" class="form-control" value="<?= old('jumlah', $pemasukan['jumlah'] ?? '') ?>" required min="0">
                        </div>
