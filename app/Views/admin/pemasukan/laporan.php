<?php echo view('Layout/Header', ['title' => $title ?? 'Laporan Pemasukan']); ?>
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4><i class="fas fa-file-alt text-success me-2"></i>Laporan Pemasukan</h4>
        <a href="<?= site_url('pemasukan') ?>" class="btn btn-secondary btn-sm">Kembali</a>
    </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover">
                    <thead class="table-dark">
                        <tr><th>#</th><th>Tanggal</th><th>Keterangan</th><th>Sumber</th><th>Jumlah</th></tr>
                    </thead>
                    <tbody>
                        <?php $total = 0; ?>
